  ...
  return (
    <Menubar className="relative border-none bg-transparent shadow-none">
      <MenubarMenu>
        ...
        <MenubarContent className="dark:border-dark-400 dark:bg-dark-300 background-light900_dark200 absolute -right-12 min-w-[120px] rounded border py-2 dark:text-white">
          {themes.map((item) => (
            <MenubarItem
              key={item.value}
              onClick={() => {
